...
\subsection*{A few more ``how to's", trouble shooting etc} 
 \begin{itemize}
 \item In generally we try to follow the language used in the paper, for example if a level of a treatment is referred to as chilling, but is actually warm, we still put it in the chilling column.
