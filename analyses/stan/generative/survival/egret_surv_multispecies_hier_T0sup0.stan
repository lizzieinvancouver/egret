...
model {
  ...
  mu_log_T0 ~ normal(log(15), log(3)/2.57); // between 5 and 40
  sigma_log_T0 ~ normal(0, log(3)/2.57); // allows between 3 and 70
  T0 ~ lognormal(mu_log_T0, sigma_log_T0);
