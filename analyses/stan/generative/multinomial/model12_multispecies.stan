...
transformed parameters {
  ...
  for (e in 1:Nexps) {
    ...
    real pv_int = mu_pv + sigma_pv * z_pv[sp];
    real bcp = beta_chill_pv + sigma_beta_chill_pv * z_beta_chill_pv[sp];
    real bcp2 = beta_chill2_pv + sigma_beta_chill2_pv * z_beta_chill2_pv[sp];
    real bfp = beta_forc_pv + sigma_beta_forc_pv * z_beta_forc_pv[sp];
    real bfp2 = beta_forc2_pv + sigma_beta_forc2_pv * z_beta_forc2_pv[sp];
    real bcfp = beta_chillforc_pv + sigma_beta_chillforc_pv * z_beta_chillforc_pv[sp];
    ...
    real bct2 = beta_chill2_tau25 + sigma_beta_chill2_tau25 * z_beta_chill2_tau25[sp];
    real bft = beta_forc_tau25 + sigma_beta_forc_tau25 * z_beta_forc_tau25[sp];
    real bft2 = beta_forc2_tau25 + sigma_beta_forc2_tau25 * z_beta_forc2_tau25[sp];
    real bctf = beta_chillforc_tau25 + sigma_beta_chillforc_tau25 * z_beta_chillforc_tau25[sp];
    ...
    real bcs2 = beta_chill2_spread + sigma_beta_chill2_spread * z_beta_chill2_spread[sp];
    real bfs = beta_forc_spread + sigma_beta_forc_spread * z_beta_forc_spread[sp];
    real bfs2 = beta_forc2_spread + sigma_beta_forc2_spread * z_beta_forc2_spread[sp];
    real bcsf = beta_chillforc_spread + sigma_beta_chillforc_spread * z_beta_chillforc_spread[sp];
