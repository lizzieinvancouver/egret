...
d$chemicalCor[which(d$checmicalCor == "Phosfert ")] <- "Phosfert(P_fertilizer)"
d$chemicalCor[which(d$checmicalCor == "phosphertt+bioplin ")] <- "Phosfert+Bioplin(N_fertilizer)"
d$chemicalCor[which(d$checmicalCor == "Thiourea")] <- "thiourea"
d$chemicalCor[which(d$checmicalCor == "Kinetin")] <- "kinetin(hormone)"
...
d$chemicalCor[which(d$checmicalCor == "GA3, Kin")] <- "GA3+kinetin"
d$chemicalCor[which(d$checmicalCor == "GA3, BAP")] <- "GA3+BAP(hormone)"
d$chemicalCor[which(d$checmicalCor == "Kin, BAP")] <- "kinetin+BAP(hormone)"
...
d$chemicalCor[which(d$checmicalCor == "GA + IBA")] <- "GA+IBA(hormone)"
d$chemicalCor[which(d$checmicalCor == "GA + BA")] <- "GA+BAP(hormone)"
d$chemicalCor[which(d$checmicalCor == "BA + IBA")] <- "BAP(hormone)+IBA(hormone)"
d$chemicalCor[which(d$checmicalCor == "BA + NAA")] <- "BAP(hormone)+NAA(hormone)"
d$chemicalCor[which(d$checmicalCor == "NAA + IBA")] <- "NAA(hormone)+IBA(hormone)"
d$chemicalCor[which(d$checmicalCor == "GA + BA + NAA")] <- "GA+BAP(hormone)+NAA(hormone)"
d$chemicalCor[which(d$checmicalCor == "GA + IBA + BA")] <- "GA+IBA(hormone)+BAP(hormone)"
d$chemicalCor[which(d$checmicalCor == "GA + NAA + IBA")] <- "GA+NAA(hormone)+IBA(hormone)"
d$chemicalCor[which(d$checmicalCor == "BA + NAA + IBA")] <- "BAP(hormone)+NAA(hormone)+IBA(hormone)"
d$chemicalCor[which(d$checmicalCor == "GA + IBA + NAA + BA")] <- "GA+IBA(hormone)+NAA(hormone)+BAP(hormone)"
d$chemicalCor[which(d$checmicalCor == "Fluridon ")] <- "Fluridon(herbicide)"
...
d$chemicalCor[which(d$checmicalCor == "GA3, PRO")] <- "GA3+PRO(hormone)"
d$chemicalCor[which(d$checmicalCor == "NOVA, MAX")] <- "NOVA(growth_regulator)+MAX(growth_regulator)"
d$chemicalCor[which(d$checmicalCor == "NOVA, MAX, PRO")] <- "NOVA(growth_regulator)+MAX(growth_regulator)+PRO(growth_regulator)"
d$chemicalCor[which(d$checmicalCor == "GA3, 6-BA")] <- "GA3+BAP(hormone)"
d$chemicalCor[which(d$checmicalCor == "E")] <- "ethephon(growth_regulator)"
...
d$chemicalCor[which(d$checmicalCor == "Milstop fungicide")] <- "MilStop(fungicide)"
d$chemicalCor[which(d$checmicalCor == "Ethephon")] <- "ethephon(growth_regulator)"
d$chemicalCor[which(d$checmicalCor == "H20")] <- "H2O"
