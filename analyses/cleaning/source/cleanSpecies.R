...
d$variety[which(d$genus == "Capparis" & d$species == "spinosa")] <- "var. canescens"
d$species[which(d$genus == "Prunus" & d$species == "azorica")] <- "lusitanica subsp. azorica"
d$variety[which(d$genus == "Prunus" & d$species == "lusitanica subsp. azorica")] <- "subsp. azorica"
d$species[which(d$genus == "Prunus" & d$species == "lusitanica subsp. azorica")] <- "lusitanica"
...
d$variety[which(d$genus == "Betula" & d$species == "platyphylla")] <- "pendula subsp. mandshurica"
d$species[which(d$genus == "Betula" & d$species == "pendula subsp. mandshurica")] <- "pendula"
...
d$variety[which(d$genus == "Tilia" & d$species == "platyphyllos subsp. corinthiaca")] <- "subsp. corinthiaca"
d$species[which(d$genus == "Tilia" & d$species == "platyphyllos subsp. corinthiaca")] <- "platyphyllos"
...
d$variety[which(d$genus == "Eucalyptus" & d$species == "pauciflora subsp. niphophila")] <- "subsp. niphophila"
d$species[which(d$genus == "Eucalyptus" & d$species == "pauciflora subsp. niphophila")] <- "pauciflora"
...
d$variety[which(d$genus == "Crambe" & d$species == "hispanica subsp. abyssinica")] <- "subsp. abyssinica"
d$species[which(d$genus == "Crambe" & d$species == "hispanica subsp. abyssinica")] <- "hispanica"
d$species[which(d$genus == "Primula" & d$species == "beesiana")] <- "bulleyana subsp. beesiana"
d$variety[which(d$genus == "Primula" & d$species == "bulleyana subsp. beesiana")] <- "subsp. beesiana"
d$species[which(d$genus == "Primula" & d$species == "bulleyana subsp. beesiana")] <- "bulleyana"
...
d$variety[which(d$genus == "Betula" & d$species == "utilis subsp. albosinensis")] <- "subsp. albosinensis"
d$species[which(d$genus == "Betula" & d$species == "utilis subsp. albosinensis")] <- "utilis"
d$species[which(d$genus == "Pedicularis" & d$species == "longiflora var.\ntubiformis")] <- "longiflora"
d$variety[which(d$genus == "Pedicularis" & d$species == "longiflora")] <- "var. tubiformis"
